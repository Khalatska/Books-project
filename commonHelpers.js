import{a as C,b as S}from"./assets/dark.-theme-8293671c.js";import{a as u,b as B}from"./assets/vendor-27708577.js";u.defaults.baseURL="https://books-backend.p.goit.global/books";async function $(){return(await u.get("/category-list")).data}async function w(){return(await u.get("/top-books")).data}async function h(e){return(await u.get(`/category?category=${e}`)).data}async function E(e){return(await u.get(`/${e}`)).data}const A="/Books-project/assets/barnes-and-noble-ee0e2630.png",T="/Books-project/assets/books-a-million-6e265484.png",q="/Books-project/assets/bookshop-0c971e03.png",j="/Books-project/assets/indiebound-cc4cda19.png",k="shopping-list",d=x(k)||[],y=async e=>{if(e.preventDefault(),e.target.nodeName!=="IMG")return;const t=e.target.dataset.id,s=await E(t);I(s);const o=document.querySelector(".addBtn");o.addEventListener("click",M(s)),d.length>0&&(d.some(a=>t===a._id)?(o.textContent="Remove from the shopping list",o.classList.add("mobileWidth")):o.textContent="Add to shopping list")},M=e=>t=>{if(t.preventDefault(),t.target.textContent==="Remove from the shopping list"){t.target.textContent="Add to shopping list",t.target.classList.remove("mobileWidth");const s=d.findIndex(o=>o._id===e._id);d.splice(s,1),_()}else t.target.textContent="Remove from the shopping list",t.target.classList.add("mobileWidth"),d.push(e),N();localStorage.setItem(k,JSON.stringify(d))};function x(e){const t=localStorage.getItem(e);try{return JSON.parse(t)}catch{return t}}function I({book_image:e,title:t,author:s,description:o,buy_links:n}){o===""&&(o="Book description has not been added yet...");const a=B.create(`<div class="modal"> 
